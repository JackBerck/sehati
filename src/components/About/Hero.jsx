...
export default function HeroAbout() {
  return (
    <section
      id="hero-about"
      className="section-padding-x pt-24 pb-8 md:pb-0 lg:pt-16 bg-[url('/img/backgrounds/persawahan.webp')] bg-cover bg-center bg-no-repeat relative text-light-base"
    >
      ...
      <div className="container max-w-screen-xl relative z-20">
        <div className="flex justify-between items-center flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0 hidden md:block">
            <img
              src="/img/random/kids-plane.webp"
              alt="Tentang Kami"
